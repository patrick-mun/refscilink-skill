...
```html
<!-- RefSciLink page header: localized title and navigation back to the host site. -->
```

```html
<!-- Reference list container populated by assets/js/reference.js. -->
```
...
<body>
  ...
  <main class="refscilink-page" data-refscilink-page="index">
    ...
    <!-- Search and filters. -->
    <section class="refscilink-controls" aria-label="{{localized_filter_area_label}}">
      <!-- Controls are defined here and wired by reference.js. -->
    </section>
