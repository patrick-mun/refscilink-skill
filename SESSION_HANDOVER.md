...
- Roadmap items 1 and 2 are validated.
```
...
- npm run test:basic-site => pass, 44 checks.
...
- official tests include config completeness, navigation integration, French UI, stable fresh-install IDs, detail-link ID usage, versioning and external-link safety checks.
```
